  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        navActive:
          "rounded-xl border-violet-500/40 bg-violet-500/15 font-medium text-violet-950 shadow-sm dark:border-violet-500/30 dark:bg-violet-500/10 dark:text-violet-50",
        adminNav:
          "rounded-xl border border-transparent font-medium text-amber-900/90 hover:border-amber-400/30 hover:bg-amber-500/10 dark:text-amber-200/90",
        adminNavActive:
          "rounded-xl border-amber-400/50 bg-amber-500/15 font-medium text-amber-950 dark:text-amber-50",
      },
      size: {
        default:
        ...
        xl: "h-auto gap-2 rounded-2xl px-6 py-3 text-sm has-data-[icon=inline-end]:pr-4 has-data-[icon=inline-start]:pl-4",
        pill: "h-auto px-3 py-1.5 text-xs",
        icon: "size-8",
        "icon-xs":
